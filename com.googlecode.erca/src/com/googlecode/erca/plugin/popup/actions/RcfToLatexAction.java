...
public class RcfToLatexAction extends ExportAction {

	public RcfToLatexAction() {
		super();
	}
	...
	public void run(IAction action) {
		for(Object object: selection.toArray() ) {
			if ( object instanceof IFile ) {
				...
				String target = source + ".tex";
				RcfToLatex latexer = new RcfToLatex(source);
				latexer.generateCode();
				try {
					latexer.toFile(target);
