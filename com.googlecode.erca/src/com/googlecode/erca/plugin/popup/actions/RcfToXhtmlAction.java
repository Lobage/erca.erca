...
public class RcfToXhtmlAction extends ExportAction {

	public RcfToXhtmlAction() {
		super();
	}
	...
	public void run(IAction action) {
		for(Object object: selection.toArray() ) {
			if ( object instanceof IFile ) {
				...
				String target = source + ".html";
				RcfToXHTML xhtmler = new RcfToXHTML(source);
				xhtmler.generateCode();
				try {
					xhtmler.toFile(target);
